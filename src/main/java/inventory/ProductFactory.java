...
public class ProductFactory {
    ...
    public static Product createProduct(String id, String name, String type, double price, int quantity) {
        ...
        if (type.equals(BOOK_TYPE) && price < 5.00) {
            throw new IllegalArgumentException("Price for BOOK must be at least $5.00");
        }

        if (type.equals(ELECTRONICS_TYPE) && price < 10.00) {
            throw new IllegalArgumentException("Price for ELECTRONICS must be at least $10.00");
        }
